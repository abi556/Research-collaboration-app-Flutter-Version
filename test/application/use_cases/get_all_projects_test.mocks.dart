...
// in research_collaboration_app/test/application/use_cases/get_all_projects_test.dart.
...
import 'package:research_collaboration_app/domain/entities/project.dart' as _i2;
...
class MockProjectRepository extends _i1.Mock implements _i3.ProjectRepository {
  ...
  @override
  _i4.Future<List<_i2.Project>> getAllProjects() => (super.noSuchMethod(
        Invocation.method(
          #getAllProjects,
          [],
        ),
  ...
  @override
  _i4.Future<_i2.Project> getProjectById(int? id) => (super.noSuchMethod(
        Invocation.method(
          #getProjectById,
          [id],
        ),
  ...
  @override
  _i4.Future<void> deleteProject(int? id) => (super.noSuchMethod(
        Invocation.method(
          #deleteProject,
          [id],
        ),
